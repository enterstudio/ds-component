...
(function (ConfigElementType) {
    ConfigElementType[ConfigElementType["DIMENSION"] = 1] = "DIMENSION";
    ConfigElementType[ConfigElementType["METRIC"] = 2] = "METRIC";
    ConfigElementType[ConfigElementType["MAX_RESULTS"] = 3] = "MAX_RESULTS";
})(ConfigElementType = exports.ConfigElementType || (exports.ConfigElementType = {}));
...
Object.defineProperty(exports, "__esModule", { value: true });
var DS = __webpack_require__(/*! ./data-studio-types */ "./src/data-studio-types.ts");
var assoc = function (t, newKey, newVal) {
    return Object.assign({}, t, (_a = {}, _a[newKey] = newVal, _a));
    var _a;
};
var zip2 = function (ts, us) {
    return ts.map(function (t, idx) { return [t, us[idx]]; });
};
var zip3 = function (ts, us, vs) {
    return ts.map(function (t, idx) { return [t, us[idx], vs[idx]]; });
};
...
var schemaEntryToField = function (configId, schemaEntry) { return ({
    id: configId,
...
exports.buildFieldsAndRows = function (message) {
    ...
    var flattenedElements = message.data.reduce(function (acc, configData) {
        return configData.elements
            .filter(function (element) {
            return element.type === DS.ConfigElementType.DIMENSION ||
    ...
    if (flattenedElements[0].type !== DS.ConfigElementType.DIMENSION) {
        throw "Your first config element must be a dimension. Your first: " + flattenedElements[0];
    }
    if (flattenedElements[1].type !== DS.ConfigElementType.METRIC) {
        throw "Your second config element must be a metric. Your first: " + flattenedElements[0];
    }
    ...
    var configs = schema.map(function (schemaEntry) {
        return schemaEntry.concept === 'DIMENSION' ? dimensionConfig : metricConfig;
    });
    var fields = zip2(schema, configs).reduce(function (acc, _a) {
        var schemaEntry = _a[0], config = _a[1];
    ...
    var fixRow = function (dataTag) { return function (row) {
        return zip3(row, schema, configs).reduce(function (acc, _a) {
            var rowValue = _a[0], schemaEntry = _a[1], config = _a[2];
            return update(acc, config.id, function (old) {
...
exports.transformData = function (message) { return (__assign({ style: message.style, type: message.type }, exports.buildFieldsAndRows(message))); };
...
exports.subscribeToData = function (callback, subscriptionOptions) {
    if (subscriptionOptions === void 0) { subscriptionOptions = { transform: data_transform_1.transformData }; }
    return __awaiter(_this, void 0, void 0, function () {
        var transform, onMessage, componentId;
        return __generator(this, function (_a) {
            transform = subscriptionOptions.transform;
            ...
            exports.postMessage({ componentId: componentId, type: 'vizReady' });
